...
?>
  <main class="main-content">
    <h2>Editar dades de l'estudiant</h2>
    <?php
      if(!empty($_POST)) {
        try {
          $dni = $_POST["dni"];
    ...
    ?>
    <a class="close-button" href="estudiants.php"><button>X</button></a>
    <a class="shit shit1" href="#">❐</a>
    <a class="shit shit2" href="#">_</a>
    <form class="form" action="registre.php" method="POST">
      ...
      <div class="input-container">
        <h3>Sel·lecciona assignatures matriculades</h3>
        <?php
      ...
      <div class="input-container button-container">
        <input type="submit" value="Crear estudiant">
      </div>
    </form>
  </main>
</body>
